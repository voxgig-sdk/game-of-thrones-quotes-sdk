# GameOfThronesQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GameOfThronesQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GameOfThronesQuotesSDK(...) and GameOfThronesQuotesSDK.test(...) become
#      GameOfThronesQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gameofthronesquotes_sdk"
_SDK_CLASS = "GameOfThronesQuotesSDK"
