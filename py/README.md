# GameOfThronesQuotes Python SDK



The Python SDK for the GameOfThronesQuotes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/game-of-thrones-quotes-sdk/releases)) or
...
```python
client = GameOfThronesQuotesSDK.test(testopts, sdkopts)
```
...
| `quotes` | `list` | Quotes by this character |
| `slug` | `str` | URL-friendly identifier for the character |
...
| --- | --- | --- |
| `id` | `str` |  |
| `members` | `list` | Members belonging to this house |
| `name` | `str` | Full name of the house |
| `slug` | `str` | URL-friendly identifier for the house |
...
```
py/
├── gameofthronesquotes_sdk.py         -- Main SDK module
...
The main module (`gameofthronesquotes_sdk`) exports the SDK class.
