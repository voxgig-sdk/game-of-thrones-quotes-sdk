...
from gameofthronesquotes_sdk.utility import register

# Load features
from gameofthronesquotes_sdk.feature.base_feature import GameOfThronesQuotesBaseFeature
from gameofthronesquotes_sdk.features import _has_feature, _make_feature
...
class GameOfThronesQuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GameOfThronesQuotesUtility()
        self._utility = utility

        from gameofthronesquotes_sdk.config import shared_config
    ...
    def get_utility(self):
        return GameOfThronesQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GameOfThronesQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from gameofthronesquotes_sdk.entity.author_entity import AuthorEntity
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from gameofthronesquotes_sdk.entity.character_entity import CharacterEntity
    ...
    def House(self, data=None) -> "HouseEntity":
        ...
        from gameofthronesquotes_sdk.entity.house_entity import HouseEntity
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from gameofthronesquotes_sdk.entity.random_entity import RandomEntity
