...
from gameofthronesquotes_sdk.core.helpers import get_ctx_prop, to_map
...
class GameOfThronesQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = GameOfThronesQuotesControl()
        ...
        if isinstance(sp, GameOfThronesQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GameOfThronesQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GameOfThronesQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return GameOfThronesQuotesOperation({})
    ...
    def make_error(self, code, msg):
        return GameOfThronesQuotesError(code, msg, self)
