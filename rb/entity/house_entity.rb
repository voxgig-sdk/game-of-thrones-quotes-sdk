# GameOfThronesQuotes SDK House entity
...
class HouseEntity
  ...
  # @return [House, Hash] the loaded House; raises GameOfThronesQuotesError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<House>, Array] the matching House items; raises GameOfThronesQuotesError on failure
