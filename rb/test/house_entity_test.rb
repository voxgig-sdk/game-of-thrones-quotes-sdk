...
class HouseEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GAMEOFTHRONESQUOTES_TEST_HOUSE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def house_basic_setup(extra)
  ...
  entid_env_raw = ENV["GAMEOFTHRONESQUOTES_TEST_HOUSE_ENTID"]
