...
#      offline in seeded test mode (GameOfThronesQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GameOfThronesQuotes_sdk.rb")
  SDK_CLASS = "GameOfThronesQuotesSDK"
  ...
  SDK_BASE = "GameOfThronesQuotes_sdk"
