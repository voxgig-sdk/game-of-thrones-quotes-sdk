...
class GameOfThronesQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GameOfThronesQuotesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GameOfThronesQuotesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GameOfThronesQuotesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
