...
// GameOfThronesQuotes SDK utility type

class GameOfThronesQuotesUtility
{
    ...
    public static function copy(GameOfThronesQuotesUtility $src): GameOfThronesQuotesUtility
    {
        $u = new GameOfThronesQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
