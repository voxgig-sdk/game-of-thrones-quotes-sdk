...
// GameOfThronesQuotes SDK utility: fetcher

class GameOfThronesQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GameOfThronesQuotesSDK/1.0)';
    ...
    public static function call(GameOfThronesQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
