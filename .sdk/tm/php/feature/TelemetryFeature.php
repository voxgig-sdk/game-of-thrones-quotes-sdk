...
// GameOfThronesQuotes SDK telemetry feature
...
class GameOfThronesQuotesTelemetryFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _close(GameOfThronesQuotesContext $ctx, bool $ok): void
    {
