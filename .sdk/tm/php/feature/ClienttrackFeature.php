...
// GameOfThronesQuotes SDK clienttrack feature
...
class GameOfThronesQuotesClienttrackFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    public function PostConstruct(GameOfThronesQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GameOfThronesQuotes-SDK';
