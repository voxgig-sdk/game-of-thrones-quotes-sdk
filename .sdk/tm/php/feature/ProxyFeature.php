...
// GameOfThronesQuotes SDK proxy feature
...
class GameOfThronesQuotesProxyFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    public function init(GameOfThronesQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GameOfThronesQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
