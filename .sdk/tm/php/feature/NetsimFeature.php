...
// GameOfThronesQuotes SDK netsim feature
...
class GameOfThronesQuotesNetsimFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _simulate(GameOfThronesQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GameOfThronesQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
