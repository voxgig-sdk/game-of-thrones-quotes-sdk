...
// GameOfThronesQuotes SDK timeout feature
...
class GameOfThronesQuotesTimeoutFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _with_timeout(GameOfThronesQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GameOfThronesQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
