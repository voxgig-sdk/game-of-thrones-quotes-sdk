...
// GameOfThronesQuotes SDK pipeline test
//
...
{
    private static function utility(): GameOfThronesQuotesUtility
    {
        return new GameOfThronesQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): GameOfThronesQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GameOfThronesQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GameOfThronesQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GameOfThronesQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GameOfThronesQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GameOfThronesQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameOfThronesQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GameOfThronesQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GameOfThronesQuotesResponse([]),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        [, $err] = GameOfThronesQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec([]),
            'response' => null,
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        [, $err] = GameOfThronesQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec(['step' => 's']),
            'response' => new GameOfThronesQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        [, $err] = GameOfThronesQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec(['step' => 's']),
            'response' => new GameOfThronesQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        [, $err] = GameOfThronesQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec(['step' => 's']),
            'response' => new GameOfThronesQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GameOfThronesQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new GameOfThronesQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec([]),
            'response' => new GameOfThronesQuotesResponse([]),
            'result' => new GameOfThronesQuotesResult([]),
        ...
        [$got, $err] = GameOfThronesQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GameOfThronesQuotesResult([])]);
        [, $err] = GameOfThronesQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GameOfThronesQuotesSpec([]), 'result' => null]);
        [, $err] = GameOfThronesQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameOfThronesQuotesSpec(['step' => 's']),
            'result' => new GameOfThronesQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameOfThronesQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameOfThronesQuotesSpec(['step' => 's']),
            'result' => new GameOfThronesQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GameOfThronesQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameOfThronesQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameOfThronesQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GameOfThronesQuotesSpec([]),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GameOfThronesQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameOfThronesQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GameOfThronesQuotesError('boom', 'boom');
        $utility->fetcher = function (GameOfThronesQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameOfThronesQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GameOfThronesQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GameOfThronesQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GameOfThronesQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GameOfThronesQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        GameOfThronesQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GameOfThronesQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameOfThronesQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GameOfThronesQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GameOfThronesQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GameOfThronesQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GameOfThronesQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GameOfThronesQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GameOfThronesQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GameOfThronesQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GameOfThronesQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GameOfThronesQuotesResult(['ok' => false])]);
        $this->expectException(GameOfThronesQuotesError::class);
        GameOfThronesQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GameOfThronesQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GameOfThronesQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        GameOfThronesQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GameOfThronesQuotesBaseFeature();
        $b = new GameOfThronesQuotesBaseFeature();
        GameOfThronesQuotesFeatureAdd::call($ctx, $a);
        GameOfThronesQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GameOfThronesQuotesBaseFeature
    {
        $f = new GameOfThronesQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GameOfThronesQuotesFeatureAdd::call($ctx, self::named_feature('a'));
        GameOfThronesQuotesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        GameOfThronesQuotesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        GameOfThronesQuotesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        GameOfThronesQuotesFeatureAdd::call($ctx, $replace);
        ...
        GameOfThronesQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GameOfThronesQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GameOfThronesQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameOfThronesQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        GameOfThronesQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GameOfThronesQuotesResponse(['headers' => null]),
            'result' => new GameOfThronesQuotesResult([]),
        ]);
        GameOfThronesQuotesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        GameOfThronesQuotesResultBody::call($ctx);
