# GameOfThronesQuotes SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # GameOfThronesQuotesSDK.new, not GameOfThronesQuotesSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    GameOfThronesQuotesSDK.new(opts)
  end
