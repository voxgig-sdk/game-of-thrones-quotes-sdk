// Command GameOfThronesQuotes-mcp is an MCP server exposing the GameOfThronesQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GameOfThronesQuotes_list  — list records of an entity
//	GameOfThronesQuotes_load  — load a single record of an entity
//
