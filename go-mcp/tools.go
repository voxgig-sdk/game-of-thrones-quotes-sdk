...
type Args struct {
	Entity string         `json:"entity" jsonschema:"author | character | house | random"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GameOfThronesQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-of-thrones-quotes_list",
		Description: "List records from GameOfThronesQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-of-thrones-quotes_load",
		Description: "Load a single record from GameOfThronesQuotes. " +
...
func runOp(client *sdk.GameOfThronesQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GameOfThronesQuotesSDK, name string) (sdk.GameOfThronesQuotesEntity, error) {
