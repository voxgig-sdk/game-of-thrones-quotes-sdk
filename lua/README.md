...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/game-of-thrones-quotes-sdk/releases)),
...
```
lua/
├── game-of-thrones-quotes_sdk.lua    -- Main SDK module
...
The main module (`game-of-thrones-quotes_sdk`) exports the SDK constructor
