...
describe("HousesDirect", function()
  it("should direct-load-houses", function()
    local setup = houses_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-houses", setup.live and "live" or "unit")
...
function houses_direct_setup(mockres)
