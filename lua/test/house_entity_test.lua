...
describe("HouseEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GAMEOFTHRONESQUOTES_TEST_HOUSE_ENTID JSON to run live")
      return
    end
...
function house_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GAMEOFTHRONESQUOTES_TEST_HOUSE_ENTID")
