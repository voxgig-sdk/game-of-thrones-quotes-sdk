...
local SDK_MODULE = "game-of-thrones-quotes_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["author"] = { ["test01"] = { id = "test01" } }, ["character"] = { ["test01"] = { id = "test01" } }, ["house"] = { ["test01"] = { id = "test01" } }, ["random"] = { ["test01"] = { id = "test01" } } } }'
