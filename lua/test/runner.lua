...
function runner.env_override(m)
  local live = runner.getenv("GAMEOFTHRONESQUOTES_TEST_LIVE")
  local override = runner.getenv("GAMEOFTHRONESQUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GAMEOFTHRONESQUOTES_TEST_EXPLAIN")
