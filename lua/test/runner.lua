...
function runner.env_override(m)
  local live = runner.getenv("GAME_OF_THRONES_QUOTES_TEST_LIVE")
  local override = runner.getenv("GAME_OF_THRONES_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GAME_OF_THRONES_QUOTES_TEST_EXPLAIN")
