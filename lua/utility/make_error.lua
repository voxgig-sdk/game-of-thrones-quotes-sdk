...
local function make_error_util(ctx, err)
  ...
  local msg = "GameOfThronesQuotesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = GameOfThronesQuotesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == GameOfThronesQuotesError then
