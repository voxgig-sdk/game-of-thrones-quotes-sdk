...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("GAMEOFTHRONESQUOTES_TEST_LIVE") == "TRUE" ||
		os.Getenv("GAMEOFTHRONESQUOTES_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("GAMEOFTHRONESQUOTES_TEST_EXPLAIN"); explain != "" {
