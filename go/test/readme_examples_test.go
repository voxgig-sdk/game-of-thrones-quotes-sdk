...
const testSeed = `map[string]any{"entity": map[string]any{"author": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "house": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
