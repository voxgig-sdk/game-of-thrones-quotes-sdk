...
func NewAuthorEntity(client *core.GameOfThronesQuotesSDK, entopts map[string]any) *AuthorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
