...
A free API to retrieve quotes from Game of Thrones.

Learn more about Game of Thrones Quotes API at [gameofthronesquotes.xyz](https://gameofthronesquotes.xyz).

This is an unofficial SDK for the Game of Thrones Quotes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| Go CLI | `github.com/voxgig-sdk/game-of-thrones-quotes-sdk/go-cli` | `go install github.com/voxgig-sdk/game-of-thrones-quotes-sdk/go-cli/cmd/game-of-thrones-quotes@latest` |
| Go MCP server | `github.com/voxgig-sdk/game-of-thrones-quotes-sdk/go-mcp` | `go get github.com/voxgig-sdk/game-of-thrones-quotes-sdk/go-mcp@latest` |
