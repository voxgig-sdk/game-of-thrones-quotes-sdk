...
// GameOfThronesQuotes SDK cache feature
...
class GameOfThronesQuotesCacheFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _through(GameOfThronesQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
