...
// GameOfThronesQuotes SDK debug feature
...
class GameOfThronesQuotesDebugFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _finish(GameOfThronesQuotesContext $ctx, bool $ok): void
    {
