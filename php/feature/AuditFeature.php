...
// GameOfThronesQuotes SDK audit feature
...
class GameOfThronesQuotesAuditFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _emit(GameOfThronesQuotesContext $ctx, string $outcome): void
    {
