...
// GameOfThronesQuotes SDK ratelimit feature
...
class GameOfThronesQuotesRatelimitFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _acquire(GameOfThronesQuotesContext $ctx): void
    {
    ...
    private function _track(GameOfThronesQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
