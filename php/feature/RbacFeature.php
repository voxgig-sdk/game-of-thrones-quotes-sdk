...
// GameOfThronesQuotes SDK rbac feature
...
class GameOfThronesQuotesRbacFeature extends GameOfThronesQuotesBaseFeature
{
    ...
    private function _required(GameOfThronesQuotesContext $ctx): ?string
    {
    ...
    private function _reject(GameOfThronesQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(GameOfThronesQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
