...
The PHP SDK for the GameOfThronesQuotes API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->GameOfThronesQuotes(null)->load(
    ["id" => "test01"], null
);
