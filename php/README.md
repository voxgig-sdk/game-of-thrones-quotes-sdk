# GameOfThronesQuotes PHP SDK



The PHP SDK for the GameOfThronesQuotes API — an entity-oriented client using PHP conventions.
...
## Install
```bash
composer require voxgig-sdk/game-of-thrones-quotes
```
...
[$result, $err] = $client->GameOfThronesQuotes()->load(["id" => "test01"]);
...
```
php/
├── gameofthronesquotes_sdk.php          -- Main SDK class
...
The main class (`gameofthronesquotes_sdk.php`) exports the SDK class
