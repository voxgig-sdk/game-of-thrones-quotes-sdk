...
// GameOfThronesQuotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GameOfThronesQuotesMakeRequest
{
    public static function call(GameOfThronesQuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GameOfThronesQuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GameOfThronesQuotesResponse($fetched);
        } else {
