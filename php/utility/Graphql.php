...
// GameOfThronesQuotes SDK utility: graphql
//
...
class GameOfThronesQuotesGraphql
{
    ...
    // equivalent.
    public static function body(GameOfThronesQuotesContext $ctx): mixed
    {
    ...
    public static function errors(GameOfThronesQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
