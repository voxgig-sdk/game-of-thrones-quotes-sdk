...
class HousesDirectTest extends TestCase
{
    public function test_direct_load_houses(): void
    {
        $setup = houses_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-houses", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
