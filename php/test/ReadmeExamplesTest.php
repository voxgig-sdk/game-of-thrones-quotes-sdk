...
// GameOfThronesQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GameOfThronesQuotesSDK::test)
...
{
    private const SDK_CLASS = 'GameOfThronesQuotesSDK';
    ...
    private const SDK_BASE = 'gameofthronesquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../gameofthronesquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
