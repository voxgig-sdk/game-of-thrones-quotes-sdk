...
func registerSDKWords(r *eng.Registry, client *sdk.GameOfThronesQuotesSDK) {
...
func runOp(client *sdk.GameOfThronesQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
